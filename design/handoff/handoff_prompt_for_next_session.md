...
### 1-A. 全体ナビゲーション統合方針 ★ 確定（2026-05-01）
- ヘッダタイトル: "CTA Gap Fill Manager" → "s-tools"
- 既存タブ改名: "承認"→"CTA挿入" / "履歴"→"CTA履歴" / "監査"→"CTA監査"
- 新規タブ: リライトキュー / リライト判定 / リライト履歴
- フラット 11タブ + カテゴリ区切り（共通 / CTA系 / リライト系）
